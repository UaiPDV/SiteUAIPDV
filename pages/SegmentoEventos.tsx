...
export const SegmentoEventos = ({ content }: { content: any }) => {
    return (
        <>
            {/* Hero Section */}
            <section className="relative isolate overflow-hidden bg-gray-900 text-white">
                <div className="absolute inset-0">
                    <img 
                        ...
                        onError={(e) => {
                            e.currentTarget.src = 'https://placehold.co/1920x1080?text=Eventos+Hero';
                        ...
                        <div className="relative">
                            <div className="rounded-3xl bg-white/10 backdrop-blur border border-white/20 p-6 shadow-2xl">
                                <img 
                                    ...
                                    onError={(e) => {
                                        e.currentTarget.src = 'https://placehold.co/600x400?text=Eventos+Device';
                                        e.currentTarget.onerror = null;
                                    }}
                                />
                            </div>
                            ...
                            <FadeSection key={idx} delay={idx * 50}>
                                <article className="rounded-3xl bg-white p-8 shadow h-full">
                                    <img 
                                        ...
                                        onError={(e) => {
                                            e.currentTarget.src = 'https://placehold.co/150x150?text=Icon';
                                            e.currentTarget.onerror = null;
                                        }}
                                    />
                            ...
                            <FadeSection key={idx} delay={idx * 50}>
                                <article className="rounded-3xl border border-gray-200 p-6 text-center h-full hover:border-brand-blue/30 transition-colors">
                                    <img 
                                        ...
                                        onError={(e) => {
                                            e.currentTarget.src = 'https://placehold.co/150x150?text=Module';
                                            e.currentTarget.onerror = null;
                                        }}
                                    />
                    ...
                    <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
                        ...
                        <div className="rounded-3xl bg-white p-6 shadow">
                            <img 
                                ...
                                onError={(e) => {
                                    e.currentTarget.src = 'https://placehold.co/600x400?text=Cloud+Events';
                                    e.currentTarget.onerror = null;
                                }}
                            />
                        </div>
