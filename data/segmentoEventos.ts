export const segmentoEventos = {
    hero: {
        kicker: "Segmentos atendidos",
        title: "Acelere suas vendas em eventos e festas",
        ...
        stats: [
            ...
            { label: "Implantação", value: "Sem burocracia" }
        ]
    },
    overview: {
        highlight: "Emissão e queima de fichas",
        title: "Operação segura para qualquer estrutura",
        description: "Solução prática para emissão de fichas, validação via aplicativo e integração direta com meios de pagamento, evitando reutilização e filas.",
        bullets: [
    ...
    features: {
        ...
        title: "Funções inteligentes para o seu evento",
        description: "Integração completa entre hardware e software para autoatendimento, vendas rápidas e validação fiscal.",
        cards: [
            {
    ...
    demo: {
        title: "Assista na prática",
        subtitle: "Veja como a solução emite e valida fichas em segundos.",
        cards: [
            {
    ...
    reasons: {
        title: "Por que escolher o UAI PDV para eventos",
        items: [
            {
                label: "1º motivo",
                title: "Controle em tempo real",
                desc: "Dashboards acompanham fichas emitidas e queimadas, garantindo transparência na operação."
            },
            {
                label: "2º motivo",
                title: "Atendimento rápido",
                desc: "Pedido, pagamento e impressão acontecem no mesmo equipamento reduzindo filas."
            },
            {
                label: "3º motivo",
                title: "Mobilidade",
                desc: "Funcionamento com bateria e rede 4G permite vender em qualquer ponto do evento."
            }
        ]
    },
    modules: {
        kicker: "Módulos",
        title: "Experiência completa do caixa ao relatório",
        subtitle: "Combine módulos fiscais, autoatendimento e gestão financeira para operar com segurança.",
        cards: [
            {
                title: "Fiscal",
    ...
    contact: {
        ...
        description: "Escolha o canal preferido e receba o plano de implantação, lista de equipamentos e condições comerciais.",
        ctaPrimary: "Quero automatizar meu evento",
        ctaSecondary: "Ver outros segmentos",
        cards: [
            {
                title: "WhatsApp imediato",
                desc: "Fale com o time comercial para definir fichas, POS e integrações.",
                link: "https://api.whatsapp.com/send?l=pt_BR&phone=553193585185"
            },
            {
                title: "Ligue para a UAI PDV",
                desc: "Tire dúvidas sobre modelos de quiosque e formas de pagamento.",
                link: "tel:553193585185"
            },
            {
                title: "Siga no Instagram",
                desc: "Acompanhe cases reais de eventos, festas e festivais atendidos.",
                link: "https://www.instagram.com/uaipdv/"
            }
        ]
    }
};